...
class FME_Fmebase_Block_System_Config_Form_Fme_Contact extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    ...
    protected function _getExtensions()
    {
        ...
        foreach ($modules as $moduleName) {
            ...
            $extension[] = array(
                'label'=>$this->__('%s Support ', $moduleConfig->extensionName . ' v' . $moduleConfig->version), 
                'value'=>$moduleConfig->extensionName.' v '.$moduleConfig->version);
        }
        return $extension;
    }

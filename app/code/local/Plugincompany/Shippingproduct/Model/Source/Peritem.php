 ...
 */
class Plugincompany_Shippingproduct_Model_Source_Peritem extends Mage_Eav_Model_Entity_Attribute_Source_Table
{
    /**
    ...
    public function getAllOptions()
    {
        return array(
					...
					array('label'=>'Per item (SKU*QTY)','value'=>1),
					array('label'=>'Per product / SKU','value'=>2),
					);
    }

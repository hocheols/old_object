 ...
 */
class Varien_Data_Form_Element_Pcfixedrate extends Varien_Data_Form_Element_Abstract
{
    /**
    ...
    public function __construct($attributes=array())
    {
        ...
        Mage::app()->getLayout()->getBlock('head')->addJs('plugincompany/shippingcountryfee.js');
    }
    ...
    {
        $html = '<input style="display:none;" class="mb_fixed_shipping_per_country" id="'.$this->getHtmlId().'" name="'.$this->getName()
    ...
    {
        $html = '<div class="entry-edit-head" style="width:439px;background:#83a9c4;margin-top:4px;"><h4>Add Country Specific Fixed Order Rates</h4></div>';
		$html .= '<div id="plugfixed" name="plugfixed" style="padding:4px;background:#d7e5ef;width:452px;height:220px;">';
		$html .= $this->getdropdown();
        $html .= '<div id="pc_fixedregions"><p><b>Select a region:</b></p></div>';
		$html .= '<input id="mb_fixedprice" style="margin-right:4px" class="validate-zero-or-greater" /><button style="margin-top:10px" type="button" onClick="addshippingvaluesFee();">Add</button></div>';
        return $html;
    }
    ...
    public function getdropdown(){
		...
		if (count($_countries) > 0): 
			$html = '<select multiple style="width:200px;float:left;margin:4px;height:212px;" name="country" id="mb_fixedcountry">
						<option id="mb_fixedzero" value="0">-- Please Select --</option>
    ...
    public function getdatatable(){
		$html = "<span class='grid'><table id='mb_fixedshippingtable' cellspacing='0' style='width:460px' class='data border'>";
